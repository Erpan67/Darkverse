...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
          'http://152.42.219.134:2106deleteUser?key=$sessionKey&username=$username',
        ),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'http://152.42.219.134:2106/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
