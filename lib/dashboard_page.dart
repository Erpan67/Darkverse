...
class _DashboardPageState extends State<DashboardPage>
  ...
  void _connectToWebSocket() {
    channel = WebSocketChannel.connect(Uri.parse('ws://152.42.219.134:2106'));
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  _openUrl("https://t.me/InfoChDarkness");
                },
              ),
            ),
          ),
  ...
  Widget _buildDrawerMenuItem({
    ...
    return Container(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: isLogout ? Colors.redAccent : accentPurple,
          size: 22,
        ),
        title: Text(
          label,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.headset_mic_outlined, color: accentPurple),
          ...
          IconButton(
            icon: const Icon(FontAwesomeIcons.userCircle, color: Color(0xFFEA80FC)),
            tooltip: 'My Profile',
            onPressed: () {
              Navigator.push(
                context,
