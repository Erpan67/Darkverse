...
class ToolsPage extends StatelessWidget {
  ...
  final Color primaryPurple = const Color(0xFF7B1FA2); // Ungu utama
  final Color accentPurple = const Color(0xFFAA00FF); // Ungu aksen lebih terang (Neon)
  final Color lightPurple = const Color(0xFFE040FB); // Ungu lebih terang untuk highlight
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    primaryPurple.withOpacity(0.3), // Diubah ke ungu
                    accentPurple.withOpacity(0.2), // Diubah ke ungu
                    primaryPurple.withOpacity(0.3), // Diubah ke ungu
                  ],
                ),
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          shadows: [
                            Shadow(
                              color: primaryPurple.withOpacity(0.8), // Diubah ke ungu
                              blurRadius: 10,
                            ),
                          ],
                        ),
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(color: primaryPurple.withOpacity(0.4), width: 1), // Diubah ke ungu
            boxShadow: [
              BoxShadow(
                color: primaryPurple.withOpacity(0.2), // Diubah ke ungu
                blurRadius: 8,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: lightPurple.withOpacity(0.3)), // Diubah ke ungu
                    boxShadow: [
                      BoxShadow(
  ...
  Widget _buildToolOption({
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: primaryPurple.withOpacity(0.3)), // Diubah ke ungu
      ),
      elevation: 4,
      shadowColor: primaryPurple.withOpacity(0.2), // Diubah ke ungu
      child: ListTile(
        leading: Container(
